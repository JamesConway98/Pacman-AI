...
import pacman.controllers.examples.JamesConway201603292;
...
public class Executor {
	...
	public static void main(String[] args) {
		...
		exec.runGameTimedSpeedOptimised(new JamesConway201603292(),new
				Legacy(),fixedTime,visual);

		//this runs the game 5 times and displays the score of each game, can take a while
		new Executor().runExperiment(new JamesConway201603292(), new Legacy(), 5);
